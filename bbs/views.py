...
def index(request):
    ...
    return render(request, "bbs/index.html", {"category_list": category_list,
            "nid": category_obj, "article_list": article_list})
...
def new_article(request):
    if request.method == "GET":
        ...
        return render(request, "bbs/new_article.html", {"category_list": category_list, "article_form": article_form})
